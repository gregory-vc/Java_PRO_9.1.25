...
1) Task4 01.11.2025 Пул потоков.
...
1) Задание 6 дедлайн 20.11
   ...
   Сервис должен давать возможность: запросить все продукты по userId, запросить продукт по productId (использовать
